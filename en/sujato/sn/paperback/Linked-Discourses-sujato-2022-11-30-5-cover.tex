\documentclass[coverheight=9in,coverwidth=6in,spinewidth=1.3054954954954956in,pagecolor=backgroundcolor,bleedwidth=3.5mm,marklength=0in,12pt]{bookcover}%
%
%
...
\spinevolumeacronym{The Group of Linked Discourses on the Path}
...
\frontvolumeacronym{\z{SN} \z{45–56}}
\frontvolumetranslationtitle{\z{The} \z{Group} \z{of} \z{Linked} \z{Discourses} \z{on} \z{the} \z{Path}}
\frontvolumeroottitle{\z{\textsanskrit{Mahāvaggasaṁyutta}}}
}

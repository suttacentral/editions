\documentclass[coverheight=9in,coverwidth=6in,spinewidth=0.9676576576576577in,pagecolor=backgroundcolor,bleedwidth=3mm,marklength=0in,12pt]{bookcover}%
%
%
...
\newcommand*{\coverimage}[1]{\vspace*{3in}\hspace*{2in}{\includegraphics[height=8in]{/app/sutta_publisher/images/red1.png}}}%
%
\begin{document}%
\pagestyle{empty}%
\normalsize%

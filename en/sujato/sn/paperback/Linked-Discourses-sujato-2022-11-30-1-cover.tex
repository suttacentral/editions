\documentclass[coverheight=9in,coverwidth=6in,spinewidth=0.9676576576576577in,pagecolor=backgroundcolor,bleedwidth=3.5mm,marklength=0in,12pt]{bookcover}%
%
%
...
\spinevolumeacronym{The Group of Linked Discourses With Verses}
...
\frontvolumeacronym{\z{SN} \z{1–11}}
\frontvolumetranslationtitle{\z{The} \z{Group} \z{of} \z{Linked} \z{Discourses} \z{With} \z{Verses}}
\frontvolumeroottitle{\z{\textsanskrit{Sagāthāvaggasaṁyutta}}}
}
...
\backvolumeblurb{“The Group of Linked Discourses With Verses” consists of eleven \textsanskrit{saṁyuttas} or “sections”, with a total of 271 suttas. Each section contains conversation involving the Buddha or his disciples with a different person or kind of person, such as gods, kings, nuns, or brahmins. In some cases, notably the \textsanskrit{Sakkasaṁyutta}, the narrative element is developed into a lively exchange. Some of the texts in this collection are well known and widely quoted, such as the invitation of \textsanskrit{Brahmā} or the nun \textsanskrit{Vajirā}’s simile of the person as a chariot. }

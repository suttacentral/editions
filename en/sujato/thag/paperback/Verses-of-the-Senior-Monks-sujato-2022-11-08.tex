...
Clearly\marginnote{3.1} seeing in every case, \\
...
\scendsutta{That is how this verse was recited by the senior venerable \textsanskrit{Puṇṇa} son of \textsanskrit{Mantāṇī}. }
...
\begin{verse}%
The\marginnote{1.1} monk who went to \textsanskrit{Sītavana} is solitary, \\
content and serene, \\
...
victorious, with goosebumps vanished, \\
\textsanskrit{Vīra} is steadfast, and has become extinguished. 
...
When your mind is upright, \textsanskrit{Hārita}, \\
...
%
\section*{{\suttatitleacronym Thag 1.42}{\suttatitletranslation Khadiravaniya }{\suttatitleroot Khadiravaniyattheragāthā}}
\addcontentsline{toc}{section}{\tocacronym{Thag 1.42} \toctranslation{Khadiravaniya } \tocroot{Khadiravaniyattheragāthā}}
\markboth{Khadiravaniya }{Khadiravaniyattheragāthā}
...
\begin{verse}%
The\marginnote{1.1} rain falls and the wind blows on mother earth, \\
...
\begin{verse}%
The\marginnote{1.1} sky rains down, like a beautiful song. \\
...
\begin{verse}%
Ethical\marginnote{1.1} conduct is best in this life, \\
...
\begin{verse}%
Whatever\marginnote{1.1} actions I have performed, \\
...
\begin{verse}%
Whatever\marginnote{1.1} bad things I’ve done \\
in previous lives, \\
...
undefiled, you’ll be fully extinguished. 
...
%
\section*{{\suttatitleacronym Thag 1.116}{\suttatitletranslation Pārāpariya (1st) }{\suttatitleroot Pārāpariyattheragāthā}}
\addcontentsline{toc}{section}{\tocacronym{Thag 1.116} \toctranslation{Pārāpariya (1st) } \tocroot{Pārāpariyattheragāthā}}
\markboth{Pārāpariya (1st) }{Pārāpariyattheragāthā}
\extramarks{Thag 1.116}{Thag 1.116}

\begin{verse}%
I’ve\marginnote{1.1} given up the six spheres of sense-contact, \\
...
A\marginnote{2.1} holy man’s color is not on the outside; \\
...
\begin{verse}%
People\marginnote{1.1} who act harshly—\\
attacking people, \\
tying them up, \\
...
\begin{verse}%
In\marginnote{1.1} \textsanskrit{Pācīnavaṁsa} grove \\
...
If\marginnote{2.1} others rebuke one \\
...
Developing\marginnote{2.1} the four kinds of mindfulness meditation, \\
...
\begin{verse}%
I\marginnote{1.1} regularly sat close by good people \\
...
%
\section*{{\suttatitleacronym Thag 2.33}{\suttatitletranslation Upavāṇa }{\suttatitleroot Upavāṇattheragāthā}}
\addcontentsline{toc}{section}{\tocacronym{Thag 2.33} \toctranslation{Upavāṇa } \tocroot{Upavāṇattheragāthā}}
\markboth{Upavāṇa }{Upavāṇattheragāthā}
...
\begin{verse}%
The\marginnote{1.1} sky rains, the sky thunders down, \\
...
\begin{verse}%
Oh,\marginnote{1.1} the Buddhas! Oh, the Dhammas! \\
...
\begin{verse}%
One\marginnote{1.1} should not suspend others from the \textsanskrit{Saṅgha}, nor raise objections against them; \\
...
I\marginnote{2.1} declare you the demon mind! \\
...
In\marginnote{3.1} the past I was related to \textsanskrit{Brahmā}, \\
...
I\marginnote{2.1} corrected my family out of compassion, \\
...
A\marginnote{3.1} monk alone is like the supreme \textsanskrit{Brahmā}; \\
...
I\marginnote{3.1} know well these states of existence are worthless—\\
...
\begin{verse}%
Others\marginnote{1.1} don’t understand \\
...
\begin{verse}%
Damn\marginnote{1.1} you mortal frame, you stink! \\
You’re on \textsanskrit{Māra}’s side, you ooze! \\
...
But\marginnote{3.1} those who are stupid fools, \\
...
He\marginnote{2.1} was glorious, the teacher of a community, \\
...
The\marginnote{2.1} sky rains down, like a beautiful song; \\
my little hut is roofed and pleasant, sheltered from the wind; \\
I meditate there, my mind at peace: \\
so rain, sky, if you wish. 

The\marginnote{3.1} sky rains down, like a beautiful song; \\
my little hut is roofed and pleasant, sheltered from the wind; \\
I meditate there, free of lust: \\
so rain, sky, if you wish. 

The\marginnote{4.1} sky rains down, like a beautiful song; \\
my little hut is roofed and pleasant, sheltered from the wind; \\
I meditate there, free of hate: \\
so rain, sky, if you wish. 

The\marginnote{5.1} sky rains down, like a beautiful song; \\
my little hut is roofed and pleasant, sheltered from the wind; \\
...
\begin{verse}%
Oh\marginnote{1.1} so well was the goad \\
...
“Whatever\marginnote{2.1} bad things I’ve done \\
in previous lives, \\
...
\begin{verse}%
Whatever\marginnote{1.1} wise one, understanding their teacher’s words, \\
...
Your body soaked with rapture, you’ll always be elated. 
...
Shall\marginnote{3.1} I … or shall I slit my wrists? \\
...
\begin{verse}%
It\marginnote{1.1} was well-taught by the seer, \\
...
\begin{verse}%
From\marginnote{1.1} where would anger come for one free of anger, \\
tamed, living justly, \\
...
%
\section*{{\suttatitleacronym Thag 7.2}{\suttatitletranslation Lakuṇṭaka Bhaddiya }{\suttatitleroot Lakuṇḍakabhaddiyattheragāthā}}
\addcontentsline{toc}{section}{\tocacronym{Thag 7.2} \toctranslation{Lakuṇṭaka Bhaddiya } \tocroot{Lakuṇḍakabhaddiyattheragāthā}}
\markboth{Lakuṇṭaka Bhaddiya }{Lakuṇḍakabhaddiyattheragāthā}
...
Out\marginnote{2.1} of compassion for me \\
...
Gotama\marginnote{4.1} traveled by that straight road; \\
...
Others\marginnote{5.1} don’t understand \\
that we need restraint in this. \\
But those who do understand this, \\
being clever, settle their conflicts. 
...
\begin{verse}%
“Old\marginnote{1.1} age and death are suffering; \\
...
The\marginnote{8.1} father of the great hermit is named Suddhodana; \\
...
“I’m\marginnote{10.1} the son of the Buddha, the incomparable \textsanskrit{Aṅgīrasa}, the poised, \\
...
In\marginnote{4.1} \textsanskrit{Sītavana}, so full of flowers, \\
...
As\marginnote{8.1} the cool breeze blows \\
with fragrant scent, \\
...
The\marginnote{4.1} Teacher, out of compassion, \\
...
Not\marginnote{4.1} protected by others, \\
...
Indra and \textsanskrit{Brahmā} came \\
...
“By\marginnote{12.1} austerity and spiritual practice, \\
...
and\marginnote{13.1} thoughts, whether liked or disliked, \\
...
%
\section*{{\suttatitleacronym Thag 14.1}{\suttatitletranslation Khadiravaniyarevata }{\suttatitleroot Khadiravaniyarevatattheragāthā}}
\addcontentsline{toc}{section}{\tocacronym{Thag 14.1} \toctranslation{Khadiravaniyarevata } \tocroot{Khadiravaniyarevatattheragāthā}}
\markboth{Khadiravaniyarevata }{Khadiravaniyarevatattheragāthā}
...
Unfaltering,\marginnote{5.1} unshakable, \\
I gladden the mind. \\
I develop the divine meditation, \\
which sinners do not cultivate. 

Having\marginnote{6.1} entered a meditation state without thought, \\
a disciple of the Buddha \\
...
There’s\marginnote{10.1} praise by fools, \\
...
The\marginnote{7.1} senior monk who was awakened right after the Buddha, \\
...
But\marginnote{10.1} one who is steady and stable, \\
...
Seeing\marginnote{12.1} in accordance with reality \\
...
When\marginnote{20.1} the bandits heard the good words of the hermit, \\
they laid down their swords and weapons. \\
Some refrained from their former deeds, \\
while others chose the going-forth. 

When\marginnote{21.1} they had gone forth in the teaching of the Holy One, \\
...
%
\section*{{\suttatitleacronym Thag 16.2}{\suttatitletranslation Pārāpariya (2nd) }{\suttatitleroot Pārāpariyattheragāthā}}
\addcontentsline{toc}{section}{\tocacronym{Thag 16.2} \toctranslation{Pārāpariya (2nd) } \tocroot{Pārāpariyattheragāthā}}
\markboth{Pārāpariya (2nd) }{Pārāpariyattheragāthā}
...
“Following\marginnote{2.1} what system, \\
...
“Who\marginnote{2.1} has crossed over the world? \\
...
That\marginnote{17.1} is how the teacher whose weapon is wisdom, \\
...
As\marginnote{18.1} a bandit caught in the door \\
...
When\marginnote{11.1} you know a thought, mindfulness is lost \\
as attention latches on a pleasant feature. \\
Experiencing it with a mind full of desire, \\
you keep clinging to it. 
...
When\marginnote{13.1} you see a sight with mindfulness, \\
...
When\marginnote{15.1} you hear a sound with mindfulness, \\
...
When\marginnote{17.1} you smell an odor with mindfulness, \\
...
Enjoying\marginnote{19.1} a taste with mindfulness, \\
...
When\marginnote{21.1} you sense a touch with mindfulness, \\
...
When\marginnote{23.1} you know a thought with mindfulness, \\
there’s no desire for thoughts. \\
Experiencing it with a mind free of desire, \\
you don’t keep clinging to it. 

Even\marginnote{24.1} as you know a thought \\
and get familiar with how it feels, \\
you wear away, you don’t heap up: \\
that’s how to live mindfully. \\
Eroding suffering like this, \\
...
Then\marginnote{9.1} who is your general, \\
...
I\marginnote{11.1} have known what should be known, \\
...
Holy,\marginnote{14.1} unequaled, \\
...
Holy,\marginnote{16.1} unequaled, \\
crusher of \textsanskrit{Māra}’s army; \\
...
“Sir,\marginnote{18.1} if you like \\
...
You\marginnote{22.1} are the Buddha, you are the Teacher, \\
...
Eating\marginnote{8.1} only what is placed in the alms-bowl, persistent, \\
happy with the scraps in my bowl: \\
Bhaddiya son of \textsanskrit{Godhā} practices absorption without grasping. 
...
Not\marginnote{19.1} socializing, persistent, \\
happy with the scraps in my bowl: \\
Bhaddiya son of \textsanskrit{Godhā} practices absorption without grasping. 
...
\begin{verse}%
“While\marginnote{1.1} walking, ascetic, you say ‘I’ve stopped.’ \\
...
“Oh,\marginnote{3.1} at long last an ascetic, \\
...
Then\marginnote{5.1} the Buddha, the compassionate great hermit, \\
...
For\marginnote{11.1} then they’d surely wish no harm \\
...
Fools\marginnote{18.1} and half-wits \\
...
“In\marginnote{22.1} the wilderness, at a tree’s root, \\
...
I\marginnote{24.1} used to belong to the brahmin caste, \\
...
Weaver\marginnote{17.1} of the web in the company of the gods, \\
now there are no future lives. \\
Transmigration through births is finished, \\
now there’ll be no more future lives.” 

“Knowing\marginnote{18.1} in an hour the galaxy, \\
...
Seven\marginnote{24.1} here, seven there, \\
...
%
\section*{{\suttatitleacronym Thag 16.10}{\suttatitletranslation Pārāpariya (3rd) }{\suttatitleroot Pārāpariyattheragāthā}}
\addcontentsline{toc}{section}{\tocacronym{Thag 16.10} \toctranslation{Pārāpariya (3rd) } \tocroot{Pārāpariyattheragāthā}}
\markboth{Pārāpariya (3rd) }{Pārāpariyattheragāthā}
...
Whether\marginnote{4.1} food was refined or rough, \\
a little or a lot, \\
...
Having\marginnote{14.1} abandoned the true teaching, \\
...
And\marginnote{19.1} in addition, tooth-picks, wood-apples, \\
flowers, food to eat, \\
...
Those\marginnote{24.1} outside the \textsanskrit{Saṅgha} \\
...
In\marginnote{9.1} the future, fools will accept \\
...
They’ll\marginnote{11.1} be arrogant, \\
...
Disparaging\marginnote{17.1} their own banner, \\
...
Devoid\marginnote{23.1} of virtue, unintelligent, \\
...
The\marginnote{25.1} conceited, arrogant fool, \\
...
“The\marginnote{12.1} wilderness is so lovely! \\
...
Entering\marginnote{19.1} meditation without thought, \\
a disciple of the Buddha \\
is at that moment blessed \\
with noble silence. 
...
“Calm\marginnote{26.1} and quiet, \\
thoughtful in counsel, and stable—\\
he shakes off bad qualities \\
as the wind shakes leaves off a tree. 

Calm\marginnote{27.1} and quiet, \\
thoughtful in counsel, and stable—\\
...
He\marginnote{36.1} is the hermit who remembered the teachings, \\
...
It’s\marginnote{16.1} enough for me, \\
...
with\marginnote{27.1} such understanding, poised, \\
steady in ethics, \\
...
Those\marginnote{29.1} whose conscience and shame \\
...
But\marginnote{31.1} if they are steady and stable, \\
alert, with senses restrained, \\
...
Oh,\marginnote{12.1} when will the rain clouds in season \\
freshly wet me in my robe in the forest, \\
walking the path trodden by the sages? \\
When will it be? 

Oh,\marginnote{13.1} when will I rise up, intent on attaining the deathless, \\
...
Oh,\marginnote{16.1} when will I realize the teaching of the great hermit \\
...
“Develop\marginnote{25.1} the eightfold path for realizing the deathless, \\
emancipating, plunging into the end of all suffering, \\
and cleansing all defilements!” \\
So you used to urge me, mind. 

“Reflect\marginnote{26.1} properly on the aggregates as suffering, \\
and abandon that from which suffering arises; \\
make an end of suffering in this very life!” \\
So you used to urge me, mind. 

“Properly\marginnote{27.1} discern that impermanence is suffering, \\
...
You\marginnote{38.1} alone make us demons; \\
...
When\marginnote{47.1} the sky has rained down, and the grass is four inches high, \\
...
You’ll\marginnote{52.1} use understanding to cut the follower of the wrong path, \\
...
You\marginnote{6.1} sack of dung wrapped up in skin! \\
...
One\marginnote{33.1} who attains the eight emancipations \\
...
free\marginnote{38.1} of thorns, with fetters ended, \\
...
Knowing\marginnote{42.1} in an hour the thousand-fold world, together with the \textsanskrit{Brahmā} realm; \\
master of psychic powers \\
and the knowledge of the passing away and rebirth of beings; \\
that mendicant sees the gods in time.” 

“\textsanskrit{Sāriputta},\marginnote{43.1} the monk who has crossed over, \\
may be supreme \\
...
There\marginnote{51.1} are mansions that last for an eon \\
...
I’m\marginnote{59.1} the one who asked \textsanskrit{Brahmā} \\
...
And\marginnote{60.1} I’m the one to whom \textsanskrit{Brahmā} \\
admitted the truth when asked. \\
...
I’m\marginnote{63.1} the one who has touched the peak of Mount Neru \\
...
“That\marginnote{69.1} is how, in the \textsanskrit{Bhesekaḷā} grove, \\
...
\scendsection{The Book of the Sixties is finished. }
...
“The\marginnote{38.1} senior monk who was awakened right after the Buddha, \\
\textsanskrit{Koṇḍañña}, is keenly energetic. \\
...
The\marginnote{50.1} seer, the Buddha, \\
...
The\marginnote{61.1} wise are bringers of light; \\
...
“He\marginnote{67.1} cut off craving for mind and body in this very life,” \\
\scspeaker{said the Buddha, }\\

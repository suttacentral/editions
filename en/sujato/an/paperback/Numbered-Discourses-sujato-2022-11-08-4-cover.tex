\documentclass[coverheight=9in,coverwidth=6in,spinewidth=1.0172072072072071in,pagecolor=backgroundcolor,bleedwidth=3mm,marklength=0in,12pt]{bookcover}%
%
%
...
\newcommand*{\coverimage}[1]{\vspace*{3in}\hspace*{2in}{\includegraphics[height=8in]{/app/sutta_publisher/images/white4.png}}}
%
%
\begin{document}%
\pagestyle{empty}%
...
\frontvolumenumber{Volume \z{4}}
\frontvolumeacronym{\z{AN} \z{7–9}}

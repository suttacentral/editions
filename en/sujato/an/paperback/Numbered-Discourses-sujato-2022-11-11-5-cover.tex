\documentclass[coverheight=9in,coverwidth=6in,spinewidth=0.8212612612612613in,pagecolor=backgroundcolor,bleedwidth=3mm,marklength=0in,12pt]{bookcover}%
%
%
...
\newcommand*{\backlogo}[1]{\raisebox{-.5ex}{\includegraphics[height=1em]{/app/sutta_publisher/images/sclogowhite.png}}}

\newcommand*{\spinelogo}[1]{\centering{\includegraphics[height=1.5em]{/app/sutta_publisher/images/sclogowhite.png}}}

\newcommand*{\coverimage}[1]{\vspace*{3in}\hspace*{2in}{\includegraphics[height=8in]{/app/sutta_publisher/images/white5.png}}}
%
%
\begin{document}%
\pagestyle{empty}%
...
\frontvolumenumber{Volume \z{5}}
\frontvolumeacronym{\z{AN} \z{10–11}}

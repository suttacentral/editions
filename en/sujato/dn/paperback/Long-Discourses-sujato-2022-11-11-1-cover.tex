\documentclass[coverheight=9in,coverwidth=6in,spinewidth=0.6500900900900901in,pagecolor=backgroundcolor,bleedwidth=3mm,marklength=0in,12pt]{bookcover}%
%
%
...
\newcommand*{\backlogo}[1]{\raisebox{-.5ex}{\includegraphics[height=1em]{/app/sutta_publisher/images/sclogoblue.png}}}

\newcommand*{\spinelogo}[1]{\centering{\includegraphics[height=1.5em]{/app/sutta_publisher/images/sclogoblue.png}}}

\newcommand*{\coverimage}[1]{\vspace*{3in}\hspace*{2in}{\includegraphics[height=8in]{/app/sutta_publisher/images/blue1.png}}}
%
%
\begin{document}%
\pagestyle{empty}%
...
\spinevolumenumber{Vol. 1}

\spinevolumeacronym{The Chapter on the Entire Spectrum of Ethics}
...
\frontvolumenumber{Volume \z{1}}
\frontvolumeacronym{\z{DN} \z{1–13}}
\frontvolumetranslationtitle{\z{The} \z{Chapter} \z{on} \z{the} \z{Entire} \z{Spectrum} \z{of} \z{Ethics}}
\frontvolumeroottitle{\z{\textsanskrit{Sīlakkhandhavagga}}}
}

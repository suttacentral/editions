\documentclass[coverheight=9in,coverwidth=6in,spinewidth=0.6208108108108108in,pagecolor=backgroundcolor,bleedwidth=3mm,marklength=0in,12pt]{bookcover}%
%
%
...
\newcommand*{\coverimage}[1]{\vspace*{3in}\hspace*{2in}{\includegraphics[height=8in]{/app/sutta_publisher/images/blue2.png}}}
%
%
\begin{document}%
\pagestyle{empty}%
...
\spinevolumeacronym{The Great Chapter}
...
\frontvolumeacronym{\z{DN} \z{14–23}}
\frontvolumetranslationtitle{\z{The} \z{Great} \z{Chapter}}
\frontvolumeroottitle{\z{\textsanskrit{Mahāvagga}}}
}

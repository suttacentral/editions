\documentclass[coverheight=9in,coverwidth=6in,spinewidth=0.9406306306306307in,pagecolor=backgroundcolor,bleedwidth=3mm,marklength=0in,12pt]{bookcover}%
%
%
...
\newcommand*{\coverimage}[1]{\vspace*{3in}\hspace*{2in}{\includegraphics[height=8in]{/app/sutta_publisher/images/yellow1.png}}}
%
%
\begin{document}%
\pagestyle{empty}%
...
\spinevolumeacronym{The First Fifty}
...
\frontvolumeacronym{\z{MN} \z{1–50}}
\frontvolumetranslationtitle{\z{The} \z{First} \z{Fifty}}
\frontvolumeroottitle{\z{\textsanskrit{Mūlapaṇṇāsa}}}
}

\documentclass[coverheight=9in,coverwidth=6in,spinewidth=0.8235135135135134in,pagecolor=backgroundcolor,bleedwidth=3mm,marklength=0in,12pt]{bookcover}%
%
%
...
\newcommand*{\backlogo}[1]{\raisebox{-.5ex}{\includegraphics[height=1em]{/app/sutta_publisher/images/sclogoyellow.png}}}

\newcommand*{\spinelogo}[1]{\centering{\includegraphics[height=1.5em]{/app/sutta_publisher/images/sclogoyellow.png}}}

\newcommand*{\coverimage}[1]{\vspace*{3in}\hspace*{2in}{\includegraphics[height=8in]{/app/sutta_publisher/images/yellow3.png}}}
%
%
\begin{document}%
\pagestyle{empty}%
...
\spinevolumeacronym{The Final Fifty}
...
\frontvolumeacronym{\z{MN} \z{101–152}}
\frontvolumetranslationtitle{\z{The} \z{Final} \z{Fifty}}
\frontvolumeroottitle{\z{\textsanskrit{Uparipaṇṇāsa}}}
}

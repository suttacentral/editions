...
\begin{verse}%
\textsanskrit{Muttā},\marginnote{1.1} be released from your yokes, \\
...
\begin{verse}%
Having\marginnote{1.1} gone forth in faith, \\
...
\begin{verse}%
I’m\marginnote{1.1} well freed, so very well freed,\footnote{Compare with \href{https://suttacentral.net/thig2.3/en/sujato}{Thig 2.3} and \href{https://suttacentral.net/thag1.43/en/sujato}{Thag 1.43}. } \\
freed from the three things that humped me:\footnote{The commentary explains that the first two things make you crooked: (\textit{\textsanskrit{khujjakaraṇahetutāya} \textsanskrit{tadubhayaṁ} “khujja”nti \textsanskrit{vuttaṁ}}), while the husband \emph{is} crooked (a hunchback). This may be so, but I think it is a double entendre. } \\
the mortar, the pestle,\footnote{The mortar and pestle feature prominently in the sexual imagery of Rig Veda 1.29, where the kitchen implements are analogized with the pressing of soma on the altar. Both \textit{musala} and “pestle” derive from roots “to pound”. } \\
...
\scendsutta{That is how the Buddha regularly advised the trainee nun \textsanskrit{Nandā} with these verses.\footnote{The MS edition is apparently alone in taking the nun as a \textsanskrit{bhikkhunī} and as the speaker of the verses. It’s odd that no variants are recorded, especially given that even the parent edition (VRI) says she is a \textit{\textsanskrit{sikkhamānā}}. Perhaps this is a rare instance of a simple oversight in MS. } }
...
\begin{verse}%
I’m\marginnote{1.1} well freed, well freed,\footnote{This verse is problematic and any translation is conjectural. I think that, like \href{https://suttacentral.net/thig1.11/en/sujato}{Thig 1.11}, it hinges on double entendres of kitchen drudgery and sex. The nun here is presumably the mother of the \textsanskrit{Sumaṅgala} at \href{https://suttacentral.net/thag1.43/en/sujato}{Thag 1.43}, whose verses are similar. } \\
...
\begin{verse}%
My\marginnote{1.1} dear mother, examine this body,\footnote{Authorship is unclear in these verses. The first verse is addressed to the mother. The commentary says it was by her son Abhaya, but I think it is more likely by her daughter \textsanskrit{Abhayā} who features in the next poem. } \\
up from the soles of the feet, \\
and down from the tips of the hairs, \\
so impure and foul-smelling. 

Meditating\marginnote{2.1} like this,\footnote{The feminine declension of the last words show that this verse is spoken by a woman. The commentary says it was by the mother, who has quoted her son’s words and adds her own. I read both verses as spoken by the daughter. } \\
all my lust is eradicated. \\
The fever of passion is cut off, \\
I’m cooled and quenched.\footnote{It is only from the feminine declension of the last words that we can be sure it is the daughter \textsanskrit{Abhayā} speaking. } 
...
\begin{verse}%
\textsanskrit{Abhayā},\marginnote{1.1} the body is fragile,\footnote{The commentary says that \textsanskrit{Abhayā} is exhorting herself here. } \\
...
\begin{verse}%
“You\marginnote{1.1} cry ‘Live, my dear mother!’ in the forest.\footnote{In her distress, \textsanskrit{Ubbirī} addresses her daughter as “mother”. The speaker of this verse, who is trying to help the distressed \textsanskrit{Ubbirī}, is not named in the text, but the commentary identifies it as the Buddha. } \\
...
“Sensual\marginnote{2.1} pleasures are like swords and spears \\
...
is master of the three knowledges, \\>conqueror of death.\footnote{\textit{\textsanskrit{Maccuhāyi}} is glossed by the commentaries as either “abandoner” (\textit{\textsanskrit{Maccuhāyinanti} \textsanskrit{maraṇapariccāginaṁ}}) or “conqueror” (\textit{\textsanskrit{maraṇābhibhū} \textsanskrit{maccuhāyī}}). The phrase seems to be used in martial contexts where it carries a similar force to \textit{\textsanskrit{jetvā} \textsanskrit{māraṁ}} just below. } \\
She bears her final body, \\
having vanquished \textsanskrit{Māra} and his mount. 
...
All\marginnote{5.1} yokes are severed, \\
...
\begin{verse}%
Due\marginnote{1.1} to irrational application of mind, \\
...
I\marginnote{5.1} examined in line with the truth \\
...
“Come \textsanskrit{Bhaddā},” he said;\footnote{This echoes the very first ordinations, where the Buddha merely said, “Come monk” (\href{https://suttacentral.net/pli-tv-kd1/en/sujato\#6.32.3}{Kd 1:6.32.3}). The use of \textit{ehi} for “come” is a sign of respect (Śatapatha \textsanskrit{Brāhmaṇa} 1.1.4.12). } \\
that was my ordination. 

“I’ve\marginnote{4.1} wandered among the \textsanskrit{Aṅgans} and Magadhans, \\
the Vajjis, \textsanskrit{Kāsis}, and Kosalans. \\
...
Out\marginnote{4.1} of sympathy for me, \\
...
Sensual\marginnote{3.1} pleasures are like swords and spears; \\
the aggregates are their chopping block. \\
What you call erotic delight \\
is now no delight for me. 
...
When\marginnote{5.1} I heard the great seer, \\
...
And\marginnote{5.1} when you’re rid of desire,\footnote{This is an allusion to \textit{\textsanskrit{rūparāgaṁ} \textsanskrit{arūparāgaṁ}}, “Desire for rebirth in the realm of luminous form, desire for rebirth in the formless realm”. } \\
...
Associate\marginnote{2.1} with true persons, \\
...
Sensual\marginnote{11.1} pleasures are like swords and spears; \\
the aggregates are their chopping block. \\
What you call erotic delight \\
is now no delight for me. 
...
If\marginnote{8.1} these rivers had carried away \\
...
go\marginnote{14.1} for refuge to the Buddha, the unaffected, \\
to his teaching and to the Sangha. \\
Undertake the precepts, \\
that will be good for you.” 

“I\marginnote{15.1} go for refuge to the Buddha, the unaffected, \\
to his teaching and to the Sangha. \\
I undertake the precepts, \\
that will be good for me. 

I\marginnote{16.1} used to be brahmin by kin, \\
...
They\marginnote{14.1} don’t receive gold coins, \\
or gold or silver; \\
...
go\marginnote{19.1} for refuge to the Buddha, the unaffected, \\
to his teaching and to the Sangha. \\
Undertake the precepts, \\
that will be good for you.” 

“I\marginnote{20.1} go for refuge to the Buddha, the unaffected, \\
to his teaching and to the Sangha. \\
I undertake the precepts, \\
that will be good for me. 

I\marginnote{21.1} used to be brahmin by kin, \\
...
back to the bank of the \textsanskrit{Nerañjara} River. \\
...
\begin{verse}%
“Before,\marginnote{1.1} good lady, when feeding \\
...
Today,\marginnote{2.1} brahmin lady, you have fed \\
all seven children. \\
...
“Having\marginnote{24.1} set forth from Varanasi \\
...
Great\marginnote{14.1} seers expel sensual pleasures, \\
both human and heavenly. \\
...
This\marginnote{16.1} is a roadblock, a threat, \\
...
Having\marginnote{24.1} once made strife \\>for the sake of sensual pleasures, \\
...
Like\marginnote{9.1} a doll made of glittering gold,\footnote{\textsanskrit{Arthaśastra} 2.13.51 describes how to alloy the  \textit{\textsanskrit{tapanīya}} (“glittering gold”) that is ready to be worked. } \\
...
Your\marginnote{17.1} eyes are like a blue lily’s bud \\
...
It’s\marginnote{28.1} like when you saw a mural made \\
by painting yellow on a wall, \\
and your vision was deceived by that—\\
the perception ‘human’ is pointless. 

Like\marginnote{29.1} an illusion cast before you, \\
or a golden tree in a dream, \\
you chase what is hollow, blind man, \\
like a painted doll among the people. 

Like\marginnote{30.1} a ball in a socket, \\
with a pupil in the middle, and tears, \\
and mucus comes from there as well, \\
different eye-parts are lumped together.” 

Having\marginnote{31.1} plucked it out, the fair-eyed lady\footnote{For \textit{\textsanskrit{cārudassanā}}, compare Sanskrit \textit{\textsanskrit{cārulocanā}}, “she whose eyes are fair”. \href{https://suttacentral.net/thig14.1/en/sujato\#18.2}{Thig 14.1:18.2} above has already established the sense “eye” for \textit{dassana}. } \\
...
And\marginnote{32.1} right then he lost his lust, \\
...
“You’re\marginnote{4.1} so lovely, Mistress \textsanskrit{Isidāsī}, \\
...
Thus\marginnote{14.1} I showed my devotion to him,\footnote{\textit{Bhatti} “devotion” in this line is followed by \textit{anuratta} (“loyal”) in the next. The persistence of senses of these words is shown by their occurrence together in the much later \textsanskrit{Haribhaktikalpalatikā} 1.10 (\textit{\textsanskrit{bhaktānuraktaṁ}}). } \\
...
But\marginnote{28.1} then Mistress \textsanskrit{Jinadattā}, \\
...
Rationally\marginnote{25.1} examining \\
...
Like\marginnote{41.1} a butcher’s knife and chopping board, \\
sensual pleasures are like a snake’s head. \\
...
Sensual\marginnote{44.1} pleasures are like swords and spears; \\
...
When\marginnote{56.1} freedom from death is there to be found, \\
why would you drink the five bitter poisons? \\
For all erotic delights \\
are so much more bitter than them. 

When\marginnote{57.1} freedom from death is there to be found, \\
...
This\marginnote{65.1} is freedom from old age, freedom from death! \\
...
This\marginnote{66.1} freedom from death has been realized by many; \\

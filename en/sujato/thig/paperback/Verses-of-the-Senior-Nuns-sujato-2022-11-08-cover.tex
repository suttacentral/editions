\documentclass[coverheight=9in,coverwidth=6in,spinewidth=0.38207207207207206in,pagecolor=backgroundcolor,bleedwidth=3mm,marklength=0in,12pt]{bookcover}%
%
%
...
\newcommand*{\coverimage}[1]{\vspace*{3in}\hspace*{2in}{\includegraphics[height=8in]{/app/sutta_publisher/images/orange6.png}}}
%
%
\begin{document}%
\pagestyle{empty}%
...
\spinetranslationtitle{Verses of the Senior Nuns} & \spinecreatorname{Bhikkhu Sujato}
\end{tabulary}
...
\fronttranslationtitle{\z{Verses} \z{of} \z{the} \z{Senior} \z{Nuns}}

\fronttranslationsubtitle{\z{A} \z{friendly} \z{translation} \z{of} \z{the} \z{\textsanskrit{Therīgāthā}}}
...
\backpublicationblurb{The “Verses of the Senior Nuns” is a collection of about 524 verses attributed to 73 of the senior nuns alive in the Buddha’s time or a little later. Celebrating the bliss of freedom and the life of meditation, the verses are full of proud and joyous proclamations of the nuns’ spiritual attainments and their gratitude to other nuns as guides and teachers. The \textsanskrit{Therīgāthā} is one of the oldest spiritual texts anywhere that records primarily women’s voices. It is a pair with the \textsanskrit{Theragāthā}, the “Verses of the Senior Monks”.}

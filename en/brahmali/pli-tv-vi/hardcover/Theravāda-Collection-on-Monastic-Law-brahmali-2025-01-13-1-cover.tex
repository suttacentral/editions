\documentclass[coverheight=9in,coverwidth=6in,spinewidth=1.3325225225225226in,pagecolor=backgroundcolor,bleedwidth=3.5mm,marklength=0in,12pt]{bookcover}%
%
%
...
\begin{bookcover}
  ...
  \spinevolumeacronym{Analysis of Rules for Monks (1)}
  ...
  \frontvolumeacronym{\z{Bu} \z{Vb}}
  \frontvolumetranslationtitle{\z{Analysis} \z{of} \z{Rules} \z{for} \z{Monks} \z{(1)}}
  \frontvolumeroottitle{\z{Bhikkhu} \z{\textsanskrit{Vibhaṅga}}}
  }

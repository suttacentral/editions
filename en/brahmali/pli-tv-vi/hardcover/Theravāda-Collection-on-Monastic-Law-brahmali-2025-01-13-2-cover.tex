\documentclass[coverheight=9in,coverwidth=6in,spinewidth=1.5464864864864865in,pagecolor=backgroundcolor,bleedwidth=3.5mm,marklength=0in,12pt]{bookcover}%
%
%
...
\begin{bookcover}
  ...
  \spinevolumeacronym{Analysis of Rules for Monks (2)}
  ...
  \frontvolumetranslationtitle{\z{Analysis} \z{of} \z{Rules} \z{for} \z{Monks} \z{(2)}}

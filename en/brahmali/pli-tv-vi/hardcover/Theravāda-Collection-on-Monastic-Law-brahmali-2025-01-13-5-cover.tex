\documentclass[coverheight=9in,coverwidth=6in,spinewidth=1.4856756756756757in,pagecolor=backgroundcolor,bleedwidth=3.5mm,marklength=0in,12pt]{bookcover}%
%
%
...
\begin{bookcover}
  ...
  \spinevolumeacronym{The Lesser Division}
  ...
  \frontvolumeacronym{\z{Kd} \z{11–22}}
  \frontvolumetranslationtitle{\z{The} \z{Lesser} \z{Division}}
  \frontvolumeroottitle{\z{\textsanskrit{Cūḷavagga}}}
  }

\documentclass[coverheight=9in,coverwidth=6in,spinewidth=1.0217117117117116in,pagecolor=backgroundcolor,bleedwidth=3.5mm,marklength=0in,12pt]{bookcover}%
%
%
...
\begin{bookcover}
  ...
  \spinevolumeacronym{Analysis of Rules for Nuns}
  ...
  \spinetranslationtitle{\textsanskrit{Theravāda} Collection on Monastic Law} & \spinecreatorname{Bhikkhu Brahmali}
  \end{tabulary}
  ...
  \frontvolumeacronym{\z{Bi} \z{Vb}}
  \frontvolumetranslationtitle{\z{Analysis} \z{of} \z{Rules} \z{for} \z{Nuns}}
  \frontvolumeroottitle{\z{\textsanskrit{Bhikkhunī}} \z{\textsanskrit{Vibhaṅga}}}
  }

\documentclass[coverheight=9in,coverwidth=6in,spinewidth=1.4406306306306307in,pagecolor=backgroundcolor,bleedwidth=3.5mm,marklength=0in,12pt]{bookcover}%
%
%
...
\begin{bookcover}
  ...
  \spinevolumenumber{Vol. 6}
  
  \spinevolumeacronym{The Compendium}
  ...
  \frontvolumenumber{\z{Volume} \z{6}}
  \frontvolumeacronym{\z{Pvr}}
  \frontvolumetranslationtitle{\z{The} \z{Compendium}}
  \frontvolumeroottitle{\z{\textsanskrit{Parivāra}}}
  }

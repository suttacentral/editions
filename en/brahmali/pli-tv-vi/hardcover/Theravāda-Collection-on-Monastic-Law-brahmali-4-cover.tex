\documentclass[coverheight=9in,coverwidth=6in,spinewidth=1.4924324324324325in,pagecolor=backgroundcolor,bleedwidth=3.5mm,marklength=0in,12pt]{bookcover}%
%
%
...
\begin{bookcover}
  ...
  \spinevolumeacronym{The Great Division}
  ...
  \frontvolumeacronym{\z{Kd} \z{1–10}}
  \frontvolumetranslationtitle{\z{The} \z{Great} \z{Division}}
